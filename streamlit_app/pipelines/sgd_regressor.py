"""SGDRegressor pipeline for minute-ahead Solana deltas."""
...
class SGDRegressorPipeline(BaseModelPipeline):
    def __init__(self) -> None:
        super().__init__(name="sgd_regressor")
    ...
    def incremental_update(
        ...
        regressor = cast(SGDRegressor, pipeline.named_steps["sgd"])
        ...
        pipeline.named_steps["sgd"] = regressor
